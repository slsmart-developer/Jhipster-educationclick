...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDYMATERIAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDYMATERIAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDYMATERIAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STUDYMATERIAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDYMATERIAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDYMATERIAL actions', async () => {
      const arg = 42666;
