...
import { getEntities, reset } from './meeting.reducer';
              ...
              <tbody>
                {meetingList.map((meeting, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>{meeting.teacher ? <Link to={`/teacher/${meeting.teacher.id}`}>{meeting.teacher.name}</Link> : ''}</td>
                    <td>{meeting.timeslot ? <Link to={`/timeslot/${meeting.timeslot.id}`}>{meeting.timeslot.startTime}</Link> : ''}</td>
                    <td>{meeting.student ? <Link to={`/student/${meeting.student.id}`}>{meeting.student.firstName}</Link> : ''}</td>
                    <td className="text-end">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button
                          onClick={() => (window.location.href = `/meeting/${meeting.id}/delete`)}
                          color="danger"
                          size="sm"
