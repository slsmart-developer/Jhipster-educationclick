...
/**
 * REST controller for managing {@link com.example.educationclick.domain.Subject}.
 */
@RestController
...
public class SubjectResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Subject>> getAllSubjects(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
